...
<div className="page-intro">
  <div>
    <span className="muted">SIGNAL LOG</span>
    <h2>Signal History</h2>
    <p>Live monitoring and completed trade results.</p>
  </div>
...
<div>
<b>LIVE SIGNALS</b>
<small>Pending, active and TP1 monitoring</small>
</div>
</div>
...
return ["PENDING","ACTIVE","TP1 HIT"].includes(s);
}).length ? (
...
<HistoryIcon size={34}/>
<b>No live signals</b>
<span>No active signal currently.</span>
</div>
...
<div className="history-section-title">
<span className="section-dot done-dot"></span>
<div>
<b>COMPLETED SIGNALS</b>
<small>TP or SL finished results</small>
</div>
</div>
...
trades.filter(t=>{
const s=String(t.status||"").toUpperCase();
return ["TP2 HIT","SL HIT"].includes(s);
}).length ? (
...
<div className="panel empty-page">
<HistoryIcon size={34}/>
<b>No completed signals yet</b>
<span>Completed TP/SL results will appear automatically.</span>
</div>
